...
####1. How to computed the camera matrix and distortion coefficients.

The code for this step is contained in the first code cell of the IPython notebook located in "./examples/Advanced_Lane_Finding.ipynb" (or in lines # through # of the file called `main.py`).  
